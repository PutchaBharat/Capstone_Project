...
public class Pageclass {
    ...
    public void AddressInfo() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(address)).sendKeys("Steel Plant, sector-5, Ukkunagram");
        wait.until(ExpectedConditions.visibilityOfElementLocated(province)).sendKeys("Vishakapatnam");
