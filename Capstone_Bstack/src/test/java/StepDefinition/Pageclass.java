...
public class Pageclass {
    ...
    By removeFromCart = By.xpath("//*[@id=\"__next\"]/div/div/div[2]/div[2]/div[2]/div/div[1]");
    ...
    public void AddressInfo() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(firstName)).sendKeys("Bharat");
        wait.until(ExpectedConditions.visibilityOfElementLocated(lastName)).sendKeys("Putcha");
        wait.until(ExpectedConditions.visibilityOfElementLocated(address)).sendKeys("Steel Plant, sector 5, Steel plant");
        wait.until(ExpectedConditions.visibilityOfElementLocated(province)).sendKeys("Vishskaptnam");
        wait.until(ExpectedConditions.visibilityOfElementLocated(postCode)).sendKeys("532218");
    }
    ...
    public void NewsletterEmail() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(newsletterEmail)).sendKeys("Pucha.Bharath@gmail.com");
    }
